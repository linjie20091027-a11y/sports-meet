...
function seedDefaultData() {
  ...
  if (evtRow.cnt === 0) {
    const events = [
      ...
      ['3000米', 'track', 'individual', 'male', 15, '采用国际田联规则', '田径场3000米起点'],
      ['3000米', 'track', 'individual', 'female', 15, '采用国际田联规则', '田径场3000米起点'],
      ['110米栏', 'track', 'individual', 'male', 8, '采用国际田联规则', '田径场110米栏赛道'],
      ['110米栏', 'track', 'individual', 'female', 8, '采用国际田联规则', '田径场100米栏赛道'],
      ['400米栏', 'track', 'individual', 'male', 8, '采用国际田联规则', '田径场400米栏赛道'],
      ['400米栏', 'track', 'individual', 'female', 8, '采用国际田联规则', '田径场400米栏赛道'],
      ['4×100米接力', 'relay', 'team', 'male', 8, '每队4人', '田径场接力区'],
      ['4×100米接力', 'relay', 'team', 'female', 8, '每队4人', '田径场接力区'],
      ['4×400米接力', 'relay', 'team', 'male', 8, '每队4人', '田径场接力区'],
      ['4×400米接力', 'relay', 'team', 'female', 8, '每队4人', '田径场接力区'],
      ['跳高', 'field', 'individual', 'male', 12, '每人3次试跳，取最好成绩', '跳高区'],
      ['跳高', 'field', 'individual', 'female', 12, '每人3次试跳，取最好成绩', '跳高区'],
      ['跳远', 'field', 'individual', 'male', 12, '每人3次试跳，取最好成绩', '沙坑区'],
      ['跳远', 'field', 'individual', 'female', 12, '每人3次试跳，取最好成绩', '沙坑区'],
      ['三级跳远', 'field', 'individual', 'male', 12, '每人3次试跳，取最好成绩', '沙坑区'],
      ['三级跳远', 'field', 'individual', 'female', 12, '每人3次试跳，取最好成绩', '沙坑区'],
      ['铅球', 'field', 'individual', 'male', 12, '每人3次投掷，取最好成绩', '投掷区'],
      ['铅球', 'field', 'individual', 'female', 12, '每人3次投掷，取最好成绩', '投掷区'],
      ['铁饼', 'field', 'individual', 'male', 12, '每人3次投掷，取最好成绩', '投掷区'],
      ['铁饼', 'field', 'individual', 'female', 12, '每人3次投掷，取最好成绩', '投掷区'],
      ['标枪', 'field', 'individual', 'male', 12, '每人3次投掷，取最好成绩', '投掷区'],
      ['标枪', 'field', 'individual', 'female', 12, '每人3次投掷，取最好成绩', '投掷区'],
    ];
    events.forEach((e, i) => {
